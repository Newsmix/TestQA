...
* Заполнение шапки документа	
	...
	Тогда открылось окно 'Поступление товара (создание) *'
* Заполнение товарной части // 2 Проверка на заполнение поля
...
* Проверка заполнения табличной части // 3 Провекра заполнения табличной части
...
* Проверка создания документа //1 Проверка на создание документа
	И таблица "Список" содержит строки:
		| 'Номер' |
		| '$Номер$'   |
		
Сценарий: проверка наличия в справочнике номенклатуры Торт 
// 4 Проверка наличия элемента в справочнике //
