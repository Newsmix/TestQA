...
Функционал: проверка формы элемента спровочника Организация
...
//Сценарий: проверка доступности вкладок налоги и валюты в справочнике Огранизации
...
//
//Сценарий: проверка функциональной опции использоать организации в Заказе клиента
